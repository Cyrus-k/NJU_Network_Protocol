all: client/app_client.o server/app_server.o client/stcp_client.o server/stcp_server.o common/seg.o
	gcc -g -pthread server/app_server.o common/seg.o server/stcp_server.o -o server/lab5-1_server
	gcc -g -pthread client/app_client.o common/seg.o client/stcp_client.o -o client/lab5-1_client
...
clean:
	...
	rm -rf server/*.o
	rm -rf common/*.o
	rm -rf client/lab5-1_client
	rm -rf server/lab5-1_server
